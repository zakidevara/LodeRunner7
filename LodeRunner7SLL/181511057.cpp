    ...
    for(int i=0;i<BARIS;i++){
        for(int j=0;j<KOLOM;j++){
            if((i == BARIS-1) || (i == BARIS-3)|| (i == BARIS-6)|| (i == BARIS-9)|| ((i == BARIS-14) && (j < 16))){
                mtxaccess(arr,i,j)->info=1;
            }else{
                mtxaccess(arr,i,j)->info=0; // assign semua nilai elemen matriks lainnya ke 0
            }
        }
    }

    // delete bata yang tidak diperlukan
    mtxaccess(arr,BARIS-3,0)->info = 0;
    mtxaccess(arr,BARIS-3,1)->info = 0;
    mtxaccess(arr,BARIS-3,2)->info = 0;
    mtxaccess(arr,BARIS-3,3)->info = 0;
    mtxaccess(arr,BARIS-3,11)->info = 0;
    mtxaccess(arr,BARIS-3,12)->info = 0;
    mtxaccess(arr,BARIS-3,13)->info = 0;
    mtxaccess(arr,BARIS-3,14)->info = 0;
    mtxaccess(arr,BARIS-3,15)->info = 0;
    mtxaccess(arr,BARIS-3,16)->info = 0;
    mtxaccess(arr,BARIS-3,17)->info = 0;
    mtxaccess(arr,BARIS-3,18)->info = 0;
    mtxaccess(arr,BARIS-3,19)->info = 0;

    mtxaccess(arr,BARIS-6,21)->info = 0;
    mtxaccess(arr,BARIS-6,22)->info = 0;
    mtxaccess(arr,BARIS-6,23)->info= 0;
    mtxaccess(arr,BARIS-6,24)->info= 0;
    mtxaccess(arr,BARIS-6,25)->info = 0;
    mtxaccess(arr,BARIS-6,26)->info = 0;
    mtxaccess(arr,BARIS-6,27)->info = 0;
    mtxaccess(arr,BARIS-6,28)->info = 0;
    mtxaccess(arr,BARIS-6,29)->info = 0;

    mtxaccess(arr,BARIS-9,8)->info = 0;
    mtxaccess(arr,BARIS-9,9)->info = 0;
    mtxaccess(arr,BARIS-9,10)->info = 0;
    mtxaccess(arr,BARIS-9,11)->info = 0;

    //penambahan bata
    mtxaccess(arr,BARIS-10,13)->info= 1;
    mtxaccess(arr,BARIS-11,13)->info= 1;
    mtxaccess(arr,BARIS-12,13)->info= 1;

    mtxaccess(arr,BARIS-10,12)->info= 1;
    mtxaccess(arr,BARIS-11,12)->info= 1;
    mtxaccess(arr,BARIS-12,12)->info= 1;

    mtxaccess(arr,BARIS-12,18)->info= 1;
    mtxaccess(arr,BARIS-12,19)->info= 1;
    mtxaccess(arr,BARIS-12,20)->info= 1;
    mtxaccess(arr,BARIS-12,21)->info= 1;
    mtxaccess(arr,BARIS-12,22)->info= 1;
    mtxaccess(arr,BARIS-12,23)->info= 1;
    mtxaccess(arr,BARIS-12,24)->info= 1;
    mtxaccess(arr,BARIS-12,25)->info= 1;
    mtxaccess(arr,BARIS-12,26)->info= 1;
    mtxaccess(arr,BARIS-12,27)->info= 1;

    //penambahan tangga
    mtxaccess(arr,BARIS-2,4)->info= 2;
    mtxaccess(arr,BARIS-3,4)->info= 2;

    mtxaccess(arr,BARIS-2,KOLOM-1)->info= 2;
    mtxaccess(arr,BARIS-3,KOLOM-1)->info= 2;

    mtxaccess(arr,BARIS-4,KOLOM-8)->info= 2;
    mtxaccess(arr,BARIS-5,KOLOM-8)->info= 2;
    mtxaccess(arr,BARIS-6,KOLOM-8)->info= 2;
    mtxaccess(arr,BARIS-7,KOLOM-8)->info= 2;
    mtxaccess(arr,BARIS-8,KOLOM-8)->info= 2;
    mtxaccess(arr,BARIS-9,KOLOM-8)->info= 2;

    mtxaccess(arr,BARIS-4,9)->info= 2;
    mtxaccess(arr,BARIS-5,9)->info= 2;
    mtxaccess(arr,BARIS-6,9)->info= 2;
    mtxaccess(arr,BARIS-4,8)->info= 2;
    mtxaccess(arr,BARIS-5,8)->info= 2;
    mtxaccess(arr,BARIS-6,8)->info= 2;

    mtxaccess(arr,BARIS-7,2)->info= 2;
    mtxaccess(arr,BARIS-8,2)->info= 2;
    mtxaccess(arr,BARIS-9,2)->info= 2;

    mtxaccess(arr,BARIS-10,7)->info= 2;
    mtxaccess(arr,BARIS-11,7)->info= 2;
    mtxaccess(arr,BARIS-12,7)->info= 2;
    mtxaccess(arr,BARIS-13,7)->info= 2;
    mtxaccess(arr,BARIS-14,7)->info= 2;

    mtxaccess(arr,BARIS-10,14)->info= 2;
    mtxaccess(arr,BARIS-11,14)->info= 2;
    mtxaccess(arr,BARIS-12,14)->info= 2;

    mtxaccess(arr,BARIS-10,KOLOM-3)->info= 2;
    mtxaccess(arr,BARIS-11,KOLOM-3)->info= 2;
    mtxaccess(arr,BARIS-12,KOLOM-3)->info= 2;

    //penambahan tali
    mtxaccess(arr,BARIS-4,10)->info = 3;
    mtxaccess(arr,BARIS-4,11)->info = 3;
    mtxaccess(arr,BARIS-4,12)->info = 3;
    mtxaccess(arr,BARIS-4,13)->info = 3;
    mtxaccess(arr,BARIS-4,14)->info = 3;
    mtxaccess(arr,BARIS-4,15)->info = 3;
    mtxaccess(arr,BARIS-4,16)->info = 3;
    mtxaccess(arr,BARIS-4,17)->info = 3;
    mtxaccess(arr,BARIS-4,18)->info = 3;
    mtxaccess(arr,BARIS-4,19)->info = 3;

    mtxaccess(arr,BARIS-13,8)->info = 3;
    mtxaccess(arr,BARIS-13,9)->info = 3;
    mtxaccess(arr,BARIS-13,10)->info = 3;
    mtxaccess(arr,BARIS-13,11)->info = 3;
    mtxaccess(arr,BARIS-13,12)->info = 3;
    mtxaccess(arr,BARIS-13,13)->info = 3;
    mtxaccess(arr,BARIS-13,14)->info = 3;
    mtxaccess(arr,BARIS-13,15)->info = 3;
    mtxaccess(arr,BARIS-13,16)->info = 3;
    mtxaccess(arr,BARIS-13,17)->info = 3;

    //penambahan koin
    mtxaccess(arr,BARIS-13,23)->info= 4;
    mtxaccess(arr,BARIS-15,4)->info= 4;
    mtxaccess(arr,BARIS-4,7)->info= 4;
    mtxaccess(arr,BARIS-2,17)->info= 4;
    mtxaccess(arr,BARIS-4,24)->info= 4;
    mtxaccess(arr,BARIS-10,22)->info= 4;
...
// arah = -1 kalau ke kiri dan arah = 1 kalau ke kanan
    ...
    if((mtxaccess(arr,baris,kolom+arah)->info == 1)){
        return true;
    }else{
        return false;
    }
...
void isi_kembali_lubang(matrix_t arr, arrayQueue* P, clock_t wkt_sekarang){
    ...
    while( (durasi > 7) && ((*P).Count > 0)){   // selagi durasi antrian paling depan sudah mencapai 7 detik
        ...
        mtxaccess(arr,Z.pos.baris,Z.pos.kolom)->info = 1;      //kembalikan lubang yang dikeluarkan dari antrian ke posisi semula
...
void resetAnimasiBom(matrix_t arr, int barisPlayer, int kolomPlayer, int* urutan, int* urutanBom, int movement, koordinat player){
    if(!isLagiBom(movement)){
                *urutanBom=-1;
                if(mtxaccess(arr,barisPlayer+1,kolomPlayer+1)->info == 7){
                    mtxaccess(arr,barisPlayer+1,kolomPlayer+1)->info = 1;
                    *urutan = 0;
                    setviewport((kolomPlayer+1)*MATRIX_ELEMENT_SIZE, (barisPlayer+1)*MATRIX_ELEMENT_SIZE, (kolomPlayer+2)*MATRIX_ELEMENT_SIZE, (barisPlayer+2)*MATRIX_ELEMENT_SIZE,1);
                    clearviewport();
                    setviewport(0,0, WINDOWS_WIDTH,WINDOWS_HEIGHT,1);
