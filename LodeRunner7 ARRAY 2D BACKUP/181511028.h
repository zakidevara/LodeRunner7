...
bool isinbrick(tElmtGrid arr[BARIS][KOLOM], posisiMatriks player, int *Nyawa);
bool ismeetbot(tElmtGrid arr[BARIS][KOLOM], spriteInfo player, int *Nyawa, spriteInfo bot[], int nBot);
