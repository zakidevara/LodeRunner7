...
void drawDown(matrix_t arr, int kolom, int baris, int n){ //menggambar matriks sebanyak 2 block ke bawah.

    for(int i=0;i<n;i++){
        //penggambaran
        if(mtxaccess(arr,baris+i,kolom)->info == 1){
        ...
        }else if(mtxaccess(arr,baris+i,kolom)->info == 2){
...
void drawUp(matrix_t arr, int kolom, int baris, int n){ //menggambar matriks sebanyak 2 block ke bawah.
    for(int i=0;i<n;i++){
        //penggambaran
        if(mtxaccess(arr,baris-i,kolom)->info == 1){
            drawBlock(MATRIX_ELEMENT_SIZE*kolom, MATRIX_ELEMENT_SIZE*(baris-i), MATRIX_ELEMENT_SIZE*(kolom+1), MATRIX_ELEMENT_SIZE*(baris+1-i));
...
void drawRight(matrix_t arr, int kolom, int baris, int n){ //menggambar matriks sebanyak 2 block ke bawah.
    for(int i=0;i<n;i++){
        //penggambaran
        if(mtxaccess(arr,baris,kolom+i)->info == 1){
        ...
        }else if(mtxaccess(arr,baris,kolom+i)->info == 2){
...
void drawLeft(matrix_t arr, int kolom, int baris, int n){ //menggambar matriks sebanyak 2 block ke bawah.
    for(int i=0;i<n;i++){
        //penggambaran
        if(mtxaccess(arr,baris,kolom-i)->info == 1){
            drawBlock(MATRIX_ELEMENT_SIZE*(kolom-i), MATRIX_ELEMENT_SIZE*(baris), MATRIX_ELEMENT_SIZE*(kolom-i+1), MATRIX_ELEMENT_SIZE*(baris+1));
